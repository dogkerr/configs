...
func (su *cok) InfoHandler(c *gin.Context) {
	...
	su.l.Info("API request to /api/v1/auth completed successfully- 18d2e020-538d-449a-8e9c-99999999",
	...
	resp := succsessResponse{Message: "API request to /api/v1/auth completed successfully",
		UserId: "18d2e020-538d-449a-8e9c-99999999"}
...
func (su *cok) ErrorHandler(c *gin.Context) {
	...
	latency := end.Sub(start)
	su.l.Warn("gagal validasi - 18d2e020-538d-449a-8e9c-99999999",
		logger.LogMetadata{Clientid: c.ClientIP(),
			Method:     c.Request.Method,
			StatusCode: 400, BodySize: c.Writer.Size(),
			Path:    c.Request.URL.Path,
			Latency: latency.String()})
	ErrorResponse(c, http.StatusBadRequest, "gagal validasi ", "18d2e020-538d-449a-8e9c-99999999")
}
...
func (su *cok) WarnHandler(c *gin.Context) {
	...
	latency := end.Sub(start)
	su.l.Warn("CPU usage warning - 18d2e020-538d-449a-8e9c-99999999",
		logger.LogMetadata{Clientid: c.ClientIP(),
			Method:     c.Request.Method,
	...
	ErrorResponse(c, http.StatusUnauthorized, "CPU usage warning", "18d2e020-538d-449a-8e9c-99999999")
}
...
func (su *cok) FatalHandler(c *gin.Context) {
	...
	latency := end.Sub(start)
	su.l.Error(errors.New("no space available for write operations - 18d2e020-538d-449a-8e9c-99999999"),
		logger.LogMetadata{Clientid: c.ClientIP(),
			Method:     c.Request.Method,
			StatusCode: 500, BodySize: c.Writer.Size(),
			Path:    c.Request.URL.Path,
			Latency: latency.String()})
	ErrorResponse(c, http.StatusInternalServerError, "no space available for write operations", "18d2e020-538d-449a-8e9c-99999999")
...
func (su *cok) DebugHandler(c *gin.Context) {
	...
	latency := end.Sub(start)
	su.l.Debug("created order ps5 - 18d2e020-538d-449a-8e9c-99999999",
		logger.LogMetadata{Clientid: c.ClientIP(),
			Method:     c.Request.Method,
			StatusCode: 201, BodySize: c.Writer.Size(),
			Path:    c.Request.URL.Path,
			Latency: latency.String()})
	resp := succsessResponse{Message: "created order ps5", UserId: "18d2e020-538d-449a-8e9c-99999999"}
...
func main() {
	...
	httpServer := httpserver.New(r, httpserver.Port("8232"))

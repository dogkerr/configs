...
func (su *cok) BadRequestHandler(c *gin.Context) {
	su.l.Error(errors.New("gagal validasi bang - 18d2e020-538d-449a-8e9c-011212999"), "http - v1 - BadRequestHandler")
...
func (su *cok) UnauthorizedHandler(c *gin.Context) {
	su.l.Error(errors.New("lu belum login bang - 18d2e020-538d-449a-8e9c-011212999"), "http - v1 - UnauthorizedHandler")
...
func (su *cok) ForbiddenHandler(c *gin.Context) {
	su.l.Error(errors.New("lu gak boleh ke sini bang - 18d2e020-538d-449a-8e9c-011212999"), "http - v1 - ForbiddenHandler")
...
func (su *cok) ServerErrorHandler(c *gin.Context) {
	su.l.Error(errors.New("maaf bang developer kita gblg, kode buatannya error semua - 18d2e020-538d-449a-8e9c-011212999"), "http - v1 - ServerErrorHandler")
